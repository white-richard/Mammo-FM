...
main(device_ids=[0],
     ...
     chk_pt="/restricted/projectnb/batmanlab/shawn24/PhD/Breast-CLIP/src/codebase/outputs/img_text_embed_bu_mayo_clip/b5_detector_n_modernbert_2048/checkpoints/fold_0/Mammo-FM_BatmanlabTrained.tar",
     batch_size=30,
     lr=0.005,
