...
#CKPT_KEY="upmc_embed"
#CLIP_CKPT="/restricted/projectnb/batmanlab/shawn24/PhD/Breast-CLIP-older-commit/src/codebase/outputs/upmc_embed_clip/b5_detector_no_downstream_no_birads_prompt_period_no_cancer_no_ethnicity_n_modernbert_2048/checkpoints/fold_0/model-upmc-embed-e13-best.tar"
...
source "/restricted/projectnb/batmanlab/shawn24/PhD/Breast-CLIP-downstream/src/scripts/configs/cmmd_configs.sh"

CMMD_LABELS=("calcification" "mass" "cancer")
#CMMD_LABELS=("cancer")
CMMD_DATA_FRACS=("1.0" "0.8" "0.5" "0.25" "0.1")
#CMMD_DATA_FRACS=("1.0")
CMMD_ARCHS=("breast_clip_det_b5_period_n_lp" "breast_clip_det_b5_period_n_ft")

#CMMD_ARCHS=("breast_clip_det_b5_period_n_ft")
#CMMD_ARCHS=("breast_clip_det_b5_period_n_lp")

for LABEL in "${CMMD_LABELS[@]}"; do
  for ARCH in "${CMMD_ARCHS[@]}"; do
    for FRAC in "${CMMD_DATA_FRACS[@]}"; do
